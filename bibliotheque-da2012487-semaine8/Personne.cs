...
namespace bibliotheque_da2012487_semaine8
{
    public class Personne
    {
        ...
        public Personne(string nom, string prenom, DateTime dateNaissance, string nas, Personne pereBiologique, Personne mereBiologique) : this(nom, prenom, dateNaissance)
        {
            this.Nom = nom ?? throw new ArgumentNullException(nameof(nom));
            this.Prenom = prenom ?? throw new ArgumentNullException(nameof(prenom));
            this.DateNaissance = dateNaissance;
       ...
       public string NomComplet
       {
        ...
        public override string ToString()
        {
            ...
            chaineCaractere.AppendLine(this.Nas ?? "Il n'y a pas de NAS.");

            chaineCaractere.AppendLine("Le père : " + this.PereBiologique.nom ?? "Il n'y a pas de pére connue.");

            chaineCaractere.AppendLine("La mère : " + this.MereBiologique.nom ?? "Il n'y a pas de mére connue.");
