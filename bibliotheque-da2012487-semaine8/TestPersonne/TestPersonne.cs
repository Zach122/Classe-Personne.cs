...
namespace TestPersonne
{
        ...
        public class PersonneTests
        {
            ...
            *******************************************************************************/
            ...
            /// </summary>
            [TestMethod()]
            public void PersonneNomCompletTest()
            {
                Personne p = new Personne(nom, prenom, DateTime.Now.AddYears(-1));
            ...
            //Test le constructeur à 3 paramètres avec des valeur vide
            [TestMethod()]
            public void PersonneConstructeurChampsVideTest()
            {
                TesterPrenomVide();
                TesterNomVide();
            }
            ...
            /// <summary>
            /// Test le constructeur à 3 paramètre avec des chaines nulles
            /// </summary>
            [TestMethod()]
            public void PersonneConstructeurChampsNullTest()
            {
                TesterNomNull();
                TesterPrenomNull();
            }
